...
/* ---------------- Query ---------------- */
const { data, rows, isLoading } = use${parent ? subName : Name}Query(page, perPage, filters)
pagination.bindMeta(data)

/* ---------------- Mutations ---------------- */
const { removeItems, removeItemsLoading } = use${parent ? subName : Name}Mutations(store.moduleName)
/* ---------------- Bulk Delete ---------------- */
